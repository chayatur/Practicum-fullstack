...
namespace MatchMakings.Core.Models
{
    ...
    public  class Women:BaseUser
    {
        ...
        public Women(string FName, string LName, string Username, string passwordHash, string Password, ERole Role) : base(FName, LName, Username, Password,passwordHash, Role)
        {
        }
        public Women()
        {
