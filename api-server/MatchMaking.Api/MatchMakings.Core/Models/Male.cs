...
namespace MatchMakings.Core.Models
{
    ...
    {
        public Male(string FName, string LName,string passwordHash, string Username, string Password, ERole Role) : base(FName, LName, Username, Password,passwordHash,Role)
        {
        }
        public Male()
        {
