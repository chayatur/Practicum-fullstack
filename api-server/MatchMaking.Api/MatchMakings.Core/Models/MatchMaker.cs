...
namespace MatchMakings.Core.Models
{
    ...
    {
        public MatchMaker(string FName, string LName, string Username, string Password,string PasswordHash, ERole Role) : base(FName, LName, Username, Password,PasswordHash, Role)
        {
        }
        public MatchMaker()
        {
