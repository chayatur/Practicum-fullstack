...
namespace MatchMakings.Data.Migrations
{
    ...
    [Migration("20250331093145_withDowm&Up")]
    partial class withDowmUp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatchMakings.Core.Models.Male", b =>
                {
                    b.HasOne("MatchMakings.Core.Models.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("MatchMakings.Core.Models.Male", "Id")
            ...
            modelBuilder.Entity("MatchMakings.Core.Models.MatchMaker", b =>
                {
                    b.HasOne("MatchMakings.Core.Models.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("MatchMakings.Core.Models.MatchMaker", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MatchMakings.Core.Models.Women", b =>
                {
                    b.HasOne("MatchMakings.Core.Models.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("MatchMakings.Core.Models.Women", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
